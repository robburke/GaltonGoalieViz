...
With the game board removed, you can use motion trails and long exposures to watch the balls bouncing down the "Plinko" pegs. Ultra-long exposure lets you see the "Plinko" trails build up in real time. In addition to looking cool, maybe this will also help you "debug" physical inaccuracies in your pinboard setup, like it did for us!  
