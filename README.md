...
A real-time computer vision app that tracks balls shot through a Galton board (bean machine, Plinko board) and visualizes the resulting bell curve distribution.
